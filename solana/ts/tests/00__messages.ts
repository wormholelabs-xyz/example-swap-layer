...
describe("Swap Layer Messages", () => {
    ...
    it("USDC Payload", function () {
        const encoded = encoding.hex.decode(
            "010000000000000000000000006ca6d1e2d5347bfab1d91e883f1915560e09129d0100000000000000000000000000000000000000000000000000000000000ba5ed00000004deadbeef00",
        );
