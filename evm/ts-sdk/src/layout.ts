...
const inputTokenItem = {
  ...
  layouts: [
    [
      [0, "Usdc"],
      [acquireModeItem, { name: "amount", ...amountItem }],
    ],
    [[1, "Gas"], [swapItem]],
    [
      [2, "Other"],
...
export const governanceCommandLayout = {
  ...
  layouts: [
    [
      [0, "UpdatePeer"],
      [{ name: "peer", ...addressChainItem }, ...feeParamsLayout],
    ],
    ...
    [
      [5, "UpdateFeeRecipient"],
      [{ name: "newFeeRecipient", ...evmAddressItem }],
    ],
    [[6, "UpgradeContract"], [{ name: "implementation", ...evmAddressItem }]],
    [[7, "EmpowerAssistant"], []],
    [
      [8, "ProposeOwnershipTransfer"],
      [{ name: "pendingOwner", ...evmAddressItem }],
    ],
